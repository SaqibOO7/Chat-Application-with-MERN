                ...
                <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input type="text" placeholder="Mohd Saqib" className="input input-bordered w-full h-10"
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Saqib" className="input input-bordered w-full h-10"
